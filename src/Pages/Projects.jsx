      ...
      <SimpleGrid >
        ...
        >
          ...
          >
            ...
            <Text color="lightgray" fontSize="14px">
              Working Area : I was handling the front-end part and created a Landing page with responsive
               and Footer page.
            </Text>
            <Text color="lightgray" fontSize="14px">
            ...
            <Text color="lightgray" fontSize="14px">
              Tech Skill used : <span style={{"fontWeight":"bold", "fontSize":"15px"}}>ReactJs | Redux | Mongodb | Express | NodeJs|
                Javascript | HTML5 | CSS3 |GPay | GitHub </span>
            </Text>
            <Flex gap={3} align="center">
              ...
              <Button size="xs" colorScheme="red">
                <Link href="https://frontend-eight-lime.vercel.app/" target="_blank">
                  <Flex align="center" gap={2}>
                    <Text>Live</Text>
                    <FaTelegramPlane />
                  </Flex>
        ...
        >
         ...
         src={theoutnet} 
          ...
          >
            ...
            <Text color="lightgray" fontSize="14px">
              Working Area :I was handling the front-end part and created a women's product
            ...
            <Text color="lightgray" fontSize="14px">
              Tech Skill used : <span style={{"fontWeight":"bold", "fontSize":"15px"}}>   Javascript | HTML5 | CSS3 | GitHub |Netlify</span>
            </Text>
            <Flex gap={3} align="center">
              <Button size="xs" colorScheme="green">
                <Link
              ...
              <Button size="xs" colorScheme="red">
                <Link href="https://incomparable-kheer-67acf9.netlify.app/" target="_blank">
                  <Flex align="center" gap={2}>
                    <Text>Live</Text>
                    <FaTelegramPlane />
                  </Flex>
        ...
        >
          ...
          >
            ...
            <Text color="lightgray" fontSize="14px">
            Working Area : I was handling the front-end part and created  salary guide page,Footer  page.
            </Text>
            <Text color="lightgray" fontSize="14px">
              Collaborative project with 4 team-members , executed in 5 days.
            </Text>
            <Text color="lightgray" fontSize="14px">
              Tech Skill used : <span style={{"fontWeight":"bold", "fontSize":"15px"}}>  ReactJs| Redux | Javascript | HTML5 | CSS3 | GitHub |Vercel</span>
            </Text>
            <Flex gap={3} align="center">
              <Button size="xs" colorScheme="green">
                <Link
              ...
              <Button size="xs" colorScheme="red">
                <Link href="https://indeed-clone-ten.vercel.app/" target="_blank">
                  <Flex align="center" gap={2}>
                    <Text>Live</Text>
                    <FaTelegramPlane />
                  </Flex>
...
src={bewakoof}
          ...
          Bewakoof.com
            ...
            <Text color="lightgray" fontSize="14px">
              Working Area : I was handling the front-end part and created footer,landing page and payment page.
            </Text>
            <Text color="lightgray" fontSize="14px">
              Collaborative project with 4 team-members , executed in 5 days.
            </Text>
            ...
            <Flex gap={3} align="center">
              ...
              <Button size="xs" colorScheme="red">
                <Link href="https://radiant-alpaca-ceefd6.netlify.app/" target="_blank">
                  <Flex align="center" gap={2}>
                    <Text>Live</Text>
                    <FaTelegramPlane />
                  </Flex>
